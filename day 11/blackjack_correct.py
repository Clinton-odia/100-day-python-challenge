...
def deal_card():
  '''Create a random card from the card deck'''
  cards = [11, 2, 3, 4, 5, 6, 7, 8, 9, 10, 10, 10, 10]
  card = random.choice(cards)
  return card

def calculate_score(cards):
  '''take a list of card number and calculate the total score'''
...
def play_game():
  ...
  print(f"Computer's first hand: {computer_cards[0]}, final score: {computer_score}")
